...
<Localised lang="en">
  ...
  {/* <div className="flex flex-col">
    <div className="px-2 flex gap-5 justify-center items-center text-base-100 bg-base-content rounded-md">
      FRONT-END:
      <div className="flex flex-col text-center">
        <I.MDX className={iconsClassName}/> <br/> MDX
      </div>
      <div className='h-15 w-0.5 border border-neutral/20'/>
      <div className="flex flex-col text-center">
        <I.Motion className={iconsClassName}/> <br/> Motion
      </div>
      <div className='h-15 w-0.5 border border-neutral/20'/>
      <div className="flex flex-col text-center">
        <I.TailwindCSS className={iconsClassName}/> <br/> Tailwind CSS
      </div>
    </div>
  </div> */}

  > - Framework : <I.Nextjs className={iconsClassName}/>
  > - Front-End : <I.MDX className={iconsClassName}/> <I.Motion className={iconsClassName}/> <I.TailwindCSS className={iconsClassName}/>
  > - Back-End : <I.Nodejs className={iconsClassName}/>
